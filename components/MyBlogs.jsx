...
import novelImage from "/public/7.jpg";
...
const MyBlogs = ({ data, handleDelete, handleEdit }) => {
  ...
  return (
    <div className="w-5/6 mx-auto flex flex-col gap-10 justify-evenly lg:justify-start  md:gap-6 lg:gap-9 flex-wrap md:flex-row ">
      {data.map((novel, i) => {
        let blogDescription = novel.information.trim().split(/\s+/);
        const shortDescription = blogDescription.slice(0, 15).join(" ");
          ...
          >
            ...
            <div className="w-[90%] mx-auto flex-1 flex flex-col justify-between  gap-2  py-2">
              ...
              <div className="text-sm text-justify  ">
                ...
                <span className=" tracking-wider">More info......</span>
              </div>
